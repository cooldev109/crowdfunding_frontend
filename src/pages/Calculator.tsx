      ...
      <div className="min-h-screen bg-gray-50 py-8 pt-24">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-primary to-secondary rounded-full mb-4">
              <CalcIcon className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
            </div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">ROI Calculator</h1>
                ...
                {result ? (
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-primary to-secondary p-4 sm:p-6 rounded-lg text-white">
                      <p className="text-xs sm:text-sm font-medium mb-2">Your Profit</p>
                      <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 break-words">
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      <div className="flex justify-between items-center gap-2 py-2 border-b">
                        <span className="text-xs sm:text-sm text-gray-600">Monthly Profit</span>
                        <span className="font-semibold text-sm sm:text-base truncate">{formatCurrency(result.statistics.monthlyProfit)}</span>
                      </div>
                      <div className="flex justify-between items-center gap-2 py-2 border-b">
                        <span className="text-xs sm:text-sm text-gray-600">Daily Profit</span>
                        <span className="font-semibold text-sm sm:text-base truncate">{formatCurrency(result.statistics.dailyProfit)}</span>
                      </div>
                      <div className="flex justify-between items-center gap-2 py-2 border-b">
                        <span className="text-xs sm:text-sm text-gray-600">Annualized Return</span>
                        <span className="font-semibold text-sm sm:text-base text-green-600">{result.statistics.annualizedReturn}%</span>
                      </div>
                      <div className="flex justify-between items-center gap-2 py-2">
                        <span className="text-xs sm:text-sm text-gray-600 flex-shrink-0">Expected Return Date</span>
                        <span className="font-semibold text-xs sm:text-sm text-right">{formatDate(result.results.expectedReturnDate)}</span>
                      </div>
                    </div>
                  </div>
                ) : (
